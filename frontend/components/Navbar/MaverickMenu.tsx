...
const menuItems = [
    {
        ...
        href: "/maverick/ai-pilot"
    },
    {
        title: "Cortex",
        subtitle: "REAL-TIME MISSION CONTROL",
        href: "/maverick/cortex"
    },
    {
        title: "Mesh",
            ...
            <div className="w-full xl:w-1/3 bg-black text-white p-6 lg:p-12 flex flex-col justify-center relative overflow-hidden z-10 shadow-lg shrink-0">
                ...
                >
                    ...
                    <div className="xl:hidden flex items-center justify-center relative w-full mb-6">
                        ...
                        <Link href="/maverick" onClick={onClose}>
                            <h2 className="text-xl font-bold tracking-tighter font-orbit text-center hover:text-[#5ce1e6] transition-colors">
                                MAVERICK
                            </h2>
                        </Link>
                    </div>
                    ...
                    {/* Desktop Title */}
                    <Link href="/maverick" onClick={onClose}>
                        <h2 className="hidden xl:block text-5xl font-bold mb-4 tracking-tighter leading-none font-orbit hover:text-[#5ce1e6] transition-colors">
                            MAVERICK
                        </h2>
                    </Link>
