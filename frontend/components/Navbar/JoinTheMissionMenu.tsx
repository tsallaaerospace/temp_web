                ...
                >
                    ...
                    <div className="xl:hidden flex items-center justify-center relative w-full mb-6">
                        ...
                        <h2 className="text-xl font-bold tracking-tighter font-orbit text-center">
                            JOIN THE <span className="text-white">MISSION</span>
                        </h2>
                    </div>

                    {/* Desktop Title */}
                    <h2 className="hidden xl:block text-3xl lg:text-4xl 2xl:text-5xl font-bold mb-4 tracking-tighter leading-none font-orbit whitespace-nowrap uppercase">
                        JOIN THE <span className="text-white">MISSION</span>
                    </h2>
                    ...
                    <p className="text-gray-400 leading-relaxed max-w-md mb-4 lg:mb-8 text-xs lg:text-sm font-light font-orbit border-l-2 border-[#5ce1e6]/30 pl-4 lg:pl-6 text-justify">
                ...
                {menuItems.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="relative z-10 w-full transition-transform duration-300">
