                ...
                <div className="pt-32 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 relative">
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-32 h-fit">
                        <Link
                            ...
                            className="group inline-flex items-center gap-3 px-5 py-2 bg-white border border-neutral-200 hover:border-black rounded-full transition-all duration-300 mb-12 hover:shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)]"
                        >
                            <div className="w-6 h-6 rounded-full bg-neutral-100 group-hover:bg-black flex items-center justify-center transition-all duration-300">
                                <MoveLeft size={12} className="text-neutral-500 group-hover:text-white transition-colors" />
                            </div>
                            <span className="font-bold text-xs uppercase tracking-widest text-neutral-500 group-hover:text-black transition-colors">Back</span>
                        </Link>
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <section className="mb-16">
                            ...
                            <ul className="space-y-4">
                                {job.responsibilities.map((item, i) => (
                                    <li key={i} className="flex items-start gap-3 text-neutral-600 text-sm md:text-base leading-relaxed text-justify">
                                        <ChevronsRight className="w-5 h-5 text-neutral-900 shrink-0 mt-1" />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="w-full h-px bg-[#E5E5E0] mb-20 relative overflow-hidden">
                            <div className="absolute left-0 top-0 w-4 h-4 -translate-y-1/2 -ml-2 -rotate-45 border border-neutral-400" />
                            <div className="absolute right-0 top-0 w-4 h-4 -translate-y-1/2 -mr-2 -rotate-45 border border-neutral-400" />
                        </div>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" className="w-full h-12 px-4 bg-white/5 border border-white/10 text-white rounded-none focus:outline-none focus:border-white transition-colors" />
                                        </div>
                                        <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input type="email" className="w-full h-12 px-4 bg-white/5 border border-white/10 text-white rounded-none focus:outline-none focus:border-white transition-colors" />
                                    </div>

                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Phone</label>
                                        <input type="tel" className="w-full h-12 px-4 bg-white/5 border border-white/10 text-white rounded-none focus:outline-none focus:border-white transition-colors" />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <button type="button" className="text-sm text-white hover:text-white/80 font-medium flex items-center gap-2 transition-colors">
                                                <Paperclip size={14} />
                                                Attach Resume
                                            </button>
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input type="url" className="w-full h-12 px-4 bg-white/5 border border-white/10 text-white rounded-none focus:outline-none focus:border-white transition-colors" />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea className="w-full h-32 p-4 bg-white/5 border border-white/10 text-white rounded-none focus:outline-none focus:border-white transition-colors resize-y" />
                                    </div>

                                    <div className="pt-8">
                                        <button
                                            type="submit"
                                            className="w-full py-4 bg-white hover:bg-neutral-200 text-black font-bold text-sm uppercase tracking-wider rounded-none transition-all hover:scale-[1.01]"
                                        >
                                            Submit Application
                                        </button>
                                    </div>
