    ...
    >
      <div className="relative block text-black no-underline h-full aspect-square md:aspect-auto md:h-auto md:py-24 bg-gray-100/50 hover:bg-gray-100 transition-colors duration-300">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center h-full p-8 transition-opacity duration-500 group-hover:opacity-0">
          <h2 className="text-2xl font-bold text-black mb-4 uppercase tracking-[0.1em]">
            {title}
          </h2>
          <p className="text-lg md:text-xl font-light leading-relaxed text-neutral-600 max-w-sm mx-auto">
            {description}
          </p>
        </div>
...
const HiringProcessPage = () => {
  return (
    <div className="min-h-screen w-full bg-white font-orbit text-black py-16 sm:py-24">
      <ContentWrapper>
        {/* Main page heading */}
        <div className="mb-12 text-center lg:text-left">
          <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-[5rem] font-bold tracking-[0.05em]">
            OUR HIRING PROCESS
          </h1>
        </div>
