...
export default function BatMission(): React.JSX.Element {
  ...
  // Get visible cards
  const visibleProfiles = isMobile ? profiles : profiles.slice(currentIndex, currentIndex + cardsPerView)
      ...
      <section className="font-clash-grotesk bg-black text-white w-full min-h-screen flex items-center justify-center py-20">
        <ContentWrapper>
          <div className="text-left mb-10 md:mb-16">
            <h1 className="text-4xl md:text-7xl font-medium tracking-tight" style={{ fontFamily: "'ClashGrotesk Bold (.eot)', sans-serif" }}>Mission Profiles</h1>
            <p className="text-lg md:text-xl text-neutral-600 mt-4">Engineered for reliability in critical scenarios.</p>
          </div>
          ...
          <div className="relative flex items-center gap-4 md:gap-8">
            ...
            <div className="flex-1 overflow-hidden">
              <AnimatePresence mode="wait" initial={false} custom={direction}>
                <motion.div
                  key={isMobile ? "mobile-grid" : currentIndex}
                  custom={direction}
