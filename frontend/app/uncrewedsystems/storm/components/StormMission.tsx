      ...
      <section className="bg-white text-black w-full">
        <div className="pt-12 px-4 md:px-20 max-w-7xl">
          <div className="text-left mb-4">
            <h1 className="section-title text-7xl leading-tight tracking-tight">Mission Profiles</h1>
            <p className="section-description mt-4">Engineered for reliability in critical scenarios.</p>
          </div>
        </div>
                ...
                >
                  ...
                  <CardHoverRevealContent className="space-y-4 rounded-2xl bg-white/80 backdrop-blur-3xl p-6 border border-black/5">
                    ...
                    <div className="space-y-2 mt-2">
                      <h3 className="section-title text-black text-2xl capitalize">
                        {profile.title}
                      </h3>
                      <p className="text-neutral-600 text-base leading-relaxed font-light">{profile.description}</p>
                    </div>
                  </CardHoverRevealContent>
                </CardHoverReveal>
              ))}
