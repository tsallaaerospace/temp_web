...
function ProfileCard({
  ...
  // Card Width
  const widthCenterDesktop = useTransform(smoothProgress, [0, 0.4, 0.8], ["28vw", "55vw", "85vw"])
  ...
  const widthCenterMobile = useTransform(smoothProgress, [0, 0.4, 0.8], ["55vw", "75vw", "98vw"])
  ...
  // Card Height
  const heightCenterDesktop = useTransform(smoothProgress, [0, 0.4, 0.8], ["70vh", "75vh", "85vh"])
  ...
  const heightCenterMobile = useTransform(smoothProgress, [0, 0.4, 0.8], ["40vh", "45vh", "65vh"])
