        ...
        <section className="w-full bg-white text-black py-12 md:py-24 overflow-hidden">
            <div className="flex flex-col overflow-hidden">
                <ContainerScroll
                    showFrame={false}
                    maxWidth="max-w-4xl"
                    heightClassName="h-[50rem] md:h-[60rem]"
                    titleComponent={
                        <div className="max-w-4xl mx-auto pb-8">
                            <motion.h2
                                ...
                                viewport={{ once: true }}
                                className="text-5xl md:text-6xl lg:text-8xl font-medium tracking-tight mb-8 leading-tight text-center"
                ...
                >
                    <div className="relative w-full h-[25rem] md:h-[35rem] mx-auto overflow-hidden rounded-2xl">
                        <video
