    ...
    <>
      ...
      <div className="font-clash-grotesk bg-neutral-950 text-white w-full overflow-hidden">
        ...
        <div className="relative w-full bg-neutral-950">
          <div className="min-h-screen flex flex-col items-center justify-center px-4 md:px-8 pt-6 pb-12 md:pt-10 md:pb-20">
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-4xl md:text-7xl font-bold text-white mb-6 md:mb-8 tracking-widest"
            >
              FENIx
            </motion.h2>

            {/* TOP SPECS ROW - Horizontal layout matching reference image */}
            <div className="w-[92%] md:w-full max-w-7xl mb-8 border border-neutral-700 overflow-hidden mx-auto">
              <div className="flex flex-col md:flex-row gap-0 md:gap-px md:divide-x divide-neutral-700">
                {topSpecs.map((spec, idx) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex-1 px-4 py-4 md:px-6 md:py-6 bg-neutral-900/50 hover:bg-neutral-800/50 transition-colors duration-300 border-b border-neutral-700 md:border-b-0"
                  >
                    <div className="flex flex-col">
                      <div className="flex items-baseline gap-1 mb-1 md:mb-2">
                        <span className="text-3xl md:text-5xl font-medium text-cyan-400">
                          {spec.value}
                        </span>
                        <span className="text-xs md:text-sm text-cyan-400/80 font-medium">{spec.unit}</span>
                      </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-full max-w-5xl -mt-8 md:-mt-40 -mb-7"
            >
              <img
            ...
            <div className="w-[92%] md:w-full max-w-7xl mt-4 md:-mt-28 flex gap-4 justify-center flex-wrap md:flex-nowrap mx-auto">
