            ...
            <div className="max-w-[1600px] mx-auto 3xl:ml-0 3xl:max-w-full">
                ...
                <div className="flex flex-col items-center justify-center text-center min-h-[70vh] mb-32 md:mb-60">
                    <motion.h2
                        ...
                        className="text-[12vw] lg:text-[9vw] font-bold text-black leading-[1.0] uppercase tracking-normal font-orbit whitespace-nowrap"
                    >
                        {/* What it <br /> provides */}
                        ...
                        {characteristics.map((item, i) => (
                            ...
                            >
                                ...
                                <div className="min-h-[3.5rem] lg:min-h-[4rem] uw:min-h-[6rem] mb-2 flex items-start">
                                    <h3 className="text-2xl lg:text-xl xl:text-2xl 2xl:text-xl 3xl:text-2xl uw:text-3xl font-bold text-black uppercase tracking-tight whitespace-nowrap group-hover:translate-x-2 transition-transform duration-500">
                                        {item.title.split('. ')[1]}
                                    </h3>
                                </div>

                                {/* Description */}
                                <p className="text-black/60 text-xs lg:text-sm xl:text-base uw:text-base leading-relaxed text-justify [hyphens:auto] group-hover:text-black transition-colors duration-500 mt-1">
                                    {item.desc}
                                </p>
